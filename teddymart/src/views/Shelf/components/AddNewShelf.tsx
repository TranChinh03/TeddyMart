      ...
      >
        ...
        <div className="grid grid-cols-4">
          ...
          <div className="col-span-3 inline-block">
            <TextInputComponent
              value={shelfName}
              setValue={(value) => handleInputChange(value, setShelfName, "shelfName")}
              width="100%"
            />
          </div>
          ...
          <div className="mt-5 col-span-3 inline-block">
            <TextInputComponent
              value={capacity}
              setValue={(value) => isNaN(Number(value)) ? message.error(t("shelf.capacityMustBeANumber")) : handleInputChange(value, setCapacity, "capacity")}
              width="100%"
            />
          </div>
        ...
        <div className="flex mt-10 items-center justify-center">
          <Space>
            <ButtonComponent
              ...
              onClick={() => {isFormValid ? onAddNewShelf() : message.error(t("fillData"))}}
            />
            <ButtonComponent
